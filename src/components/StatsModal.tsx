...
export const StatsModal = () => {
  ...
  customStyles.content!.backgroundColor = mode === 'Dark' ? '#262B3C' : 'rgba(243, 243, 243, 0.89)';
  customStyles.overlay!.backgroundColor = mode === 'Dark' ? 'rgba(38, 43, 60, 0.89)' : 'rgba(243, 243, 243, 0.89)';
  return (
    <Modal
